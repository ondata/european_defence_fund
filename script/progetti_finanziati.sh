...
# Crea un file di esempio con i primi 5 risultati
jq '.results[0:5]' "$folder"/../data/progetti_finanziati/raw/progetti_finanziati.json > "$folder"/../data/sample/progetti_finanziati_sample.json
