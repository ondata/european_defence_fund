...
jq '.results[0:3] | map({reference: .reference, participants: .metadata.participants[0]})' "$folder"/../data/progetti_finanziati/raw/progetti_finanziati.json > "$folder"/../data/sample/progetti_finanziati_sample.json
