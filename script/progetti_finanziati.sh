...
# conteggio totale dei progetti finanziati
...
flatterer --force "${folder}"/../data/progetti_finanziati/processing/progetti_finanziati.json "${folder}"/../data/progetti_finanziati/processing/flatten
